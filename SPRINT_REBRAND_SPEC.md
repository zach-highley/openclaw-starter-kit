...
Before committing:
```bash
grep -rn "Zach\|zachhgg\|zhighley\|Yoda\|[CHAT_ID]\|8590673254\|Highley\|Gergel\|McKinsey\|Nino\|Kenny\|zach@" . --include="*.md" --include="*.py" --include="*.sh" --include="*.json" | grep -v ".git/"
```
